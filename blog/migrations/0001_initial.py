    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_title', models.CharField(help_text='Overwrite the def title', max_length=100)),
            ],
            options={
                'abstract': False,
            },
